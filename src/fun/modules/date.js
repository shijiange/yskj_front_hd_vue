 ...
 */
export function timeElAddZero(dateEl) {
 ...
 * @returns object 时间元素
 */
export function getTimeElByMillisecond(millisecond) {
  let seconds = Math.round((millisecond % (60 * 1000)) / 1000);
  let minutes = Math.round(millisecond / 1000 / 60) % 60;
  let hours = Math.floor(millisecond / 1000 / 60 / 60) % 24;
  let days = Math.floor(millisecond / 1000 / 60 / 60 / 24);
