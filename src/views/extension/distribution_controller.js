...
export default {
  ...
  methods: {
    ...
    getLevelData() {
      ...
      $http.get("plugin.commission.api.commission.get-agent-level", json).then(
        function(response) {
    ...
    getDistributionCommissionData() {
      let that = this;
      let json = { i: this.fun.getKeyByI(), type: this.fun.getTyep() };
      $http.get("plugin.commission.api.commission.get-commission", json).then(
        function(response) {
          console.log(response);
          if (response.result == 1) {
    ...
    getAgentCountData() {
      let that = this;
      let json = { i: this.fun.getKeyByI(), type: this.fun.getTyep() };
      $http.get("member.member.getMyAgentCount", json).then(
        function(response) {
          console.log(response);
          if (response.result == 1) {
