              ...
              <div class="imgflex" @click="selectIndex(6)">
                <van-uploader :after-read="onRead" style="width: 100%;">
                  <div style="padding: 0.25rem 1rem; width: 100%; height: 11rem;">
                    <img
                      :src="apply.id_card_image_back ? apply.id_card_image_back : 'https://mini-app-img-1251768088.cos.ap-guangzhou.myqcloud.com/bg_idcard_up@2x.png'"
                      style="width: 100%;"
                      class="avatar"
                    />
                  </div>
            ...
            <div class="otherphoto" style="padding-bottom: 0.625rem;">
              <div class="imgflex" @click="selectIndex(5)">
                <van-uploader :after-read="onRead" style="width: 100%;">
                  <div style="padding: 0.25rem 1rem; width: 100%; height: 11rem;">
                    <img
                      :src="apply.id_card_image_front ? apply.id_card_image_front : 'https://mini-app-img-1251768088.cos.ap-guangzhou.myqcloud.com/bg_idcard_down@2x.png'"
                      style="width: 100%;"
                      class="avatar"
                    />
                  </div>
