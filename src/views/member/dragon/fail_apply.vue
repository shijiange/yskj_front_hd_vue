        ...
        <div class="form_four">
          ...
          <div class="list">
            ...
            <div class="image-three"
                 :style="{backgroundImage: 'url(' + (formData.legalBack ?  formData.legalBack.legalBackURL : require('../../../assets/images/bg_idcard_up.png')) + ')'}">
              <div class="icon">
          ...
          <div class="list">
            <span>法人身份证国徽面</span>
            <div class="image-two"
                 :style="{backgroundImage: 'url(' + (formData.legalFront ?  formData.legalFront.legalFrontURL : require('../../../assets/images/bg_idcard_down.png')) + ')'}">
              <div class="icon">
