    ...
    <div class="content" v-if="status == '-1'">
      <template v-if="config_status == '1'">
        ...
        <div class="text">
          ...
          如果成为{{merchant_center || '招商中心'}}，那么只要您团队粉丝成为了供应商，可获得供应商的商品分红哦，快来申请吧~
        </div>
      ...
      <template v-if="config_status == '2'">
        ...
        <div class="text">
          ...
          >人，如果成为{{merchant_center || '招商中心'}}，那么只要您团队粉丝成为了供应商，可获得供应商的商品分红哦，快来申请吧~
        </div>
        <template v-if="independent_backend == 1">
          <van-field v-model="username" label="登录账号" placeholder="登录账号" />
          <van-field v-model="password" type="password" label="登录密码" placeholder="输入登录密码" />
      ...
      <template v-if="config_status == '4'">
        ...
        <div class="text">
          ...
          >元，如果成为{{merchant_center || '招商中心'}}，那么只要您团队粉丝成为了供应商，可获得供应商的商品分红哦，快来申请吧~
        </div>
        <template v-if="independent_backend == 1">
          <van-field v-model="username" label="登录账号" placeholder="登录账号" />
          <van-field v-model="password" type="password" label="登录密码" placeholder="输入登录密码" />
