...
export default {
  ...
  methods: {
    ...
    initMailLanguage() {
      ...
      this.leveling_label = this.fun.setMailLanguage(
        "平级奖",
        this.mailLanguage.team_fjyx.flat_prize
      );
      this.extra_award_label = this.fun.setMailLanguage(
        "额外奖励",
        this.mailLanguage.team_fjyx.extra_award
      );
    },
