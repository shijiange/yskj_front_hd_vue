  ...
  <div id="teamAgentCenter">
    ...
    <div class="share_holder">
      ...
      <div class="code_box">
        ...
        <router-link :to="fun.getUrl('commissionSummary')" v-if="is_show_order_survey != 0">
          <div class="list1 code">
            <div class="ico extension"></div>
            提成概括
            <i class="fa fa-angle-right"></i>
      ...
      <ul class="today_bonus" v-if="is_commission_record != 0">
    ...
    <div class="money" v-if="is_commission_record != 0">
      <ul class="gongge">
        <!--<li>-->
    ...
    <div class="content" v-if="is_commission_record != 0">
