  ...
  <div id="balance_recharge">
    ...
    <div class="pay-box">
      ...
      <div class="pay-money">
        ...
        <div class="bottom" v-if="order_sn">
    ...
    <div id="payBtnList">
      ...
      <template v-if="money > 0">
        <!--yz_pay 包括支付需要的弹窗和红包-->
        <yz_pay :payType="buttons" :typename="typename" @submit="confirm" :popupSpecs="popupSpecs" :balanceNum="balance"
...
<script>
import liveAuthorization_pay_controller from "./liveAuthorization_pay_controller";
export default liveAuthorization_pay_controller;
</script>
