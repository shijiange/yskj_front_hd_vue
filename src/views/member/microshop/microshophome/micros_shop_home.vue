<template>
  <div id="microShop_main">
    ...
    <div class="home">
      ...
      >
        <div class="content1">
          <div class="picture1">
            ...
            <img v-else src="../../../../assets/images/photo-mr.jpg" alt="用户头像" />
          </div>
          <div class="name1">
            <span>{{ username }}</span>
            <br />{{ signName }}
      ...
      <van-swipe class="my-swipe" :autoplay="2000" indicator-color="white" v-if="bannerData.length > 0">
        <van-swipe-item v-for="(item, i) in bannerData" :key="i">
          <template v-if="item.thumb">
            <img :src="item.thumb" width="100%" @click="tohref(item.link)" />
          </template>
          <template v-if="!item.thumb">
      ...
      <div class="goodsList" v-if="goodsListData && !fun.isTextEmpty(goodsListData)">
