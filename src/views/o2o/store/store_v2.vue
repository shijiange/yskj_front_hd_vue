  ...
  <div id="all" style="position: relative; height: 100vh;" :class="[this.fun.getPhoneEnv() == 3 ? 'pcStyle' : '']">
    <div class="content" :style="{ backgroundImage: 'url(' + store.store_barnner_thumb + ')' }" v-show="!loadingPopup">
      ...
      <div class="storeInfo_box" ref="storeInfo_box" :class="{ amout: amout }">
        ...
        <div class="storeImg" :style="{ borderRadius: store.logo_style ? '0' : '50%' }">
          <img :src="store.store_thumb" :style="{ borderRadius: store.logo_style ? '0' : '50%' }" />
        </div>
      </div>
      <div class="menu_evaluate_business">
              ...
              <div>
                <div class="food-list">
                  <div class="food-list-hook">
                    ...
                    <template v-for="(food, i) in goods">
                      <div class="Goods" @click.stop="goToGoodsO2O(food)">
                        ...
                        <div class="goods_right">
                          <ul class="goodsName">
                            ...
                            <template v-else>
                              <li class="sum sum1" v-if="food.vip_level_status && food.vip_level_status.status == 1">
                                {{ $i18n.t("money") }} <span style="color: #fff;"> {{ food.vip_level_status.word }}</span>
                              </li>
                              <li class="sum" v-else>
                          ...
                          <div class="specBtn" v-if="food.has_option === 1 && (!food.vip_level_status || food.vip_level_status.status == 0) && !food.reserve_goods">
                      ...
                      <div class="goods_content_show" style="display: flex;flex-wrap: wrap;margin-top: 4px;" v-if="food.goods_content_show" :key="i">
                        <!-- 商品内容显示 #81889-->
                        <template v-for="(contentChild, contentChild_index) in food.goods_content_show">
                          <div style="font-size:10px;color:#666;margin: 0 8px 0 0;" :key="contentChild_index">{{ contentChild.name }}{{ contentChild.value }}%</div>
                        </template>
                      </div>
                    ...
                    <!--showLength为了补位滑动-->
                    <div class="Goods" style="height: 6rem;" v-for="food in showLength" :key="food"></div>
                  </div>
            ...
            <div class="user_box" v-for="(comment, i) in new_comment" :key="i">
              ...
              <div class="user_info">
                ...
                <div class="goodlnfo" v-if="comment.has_one_goods && comment.has_one_goods.id" @click="gotoGoodDetail(comment.has_one_goods.id)">
                  <img :src="comment.has_one_goods.img" alt="" />
                  <div class="goodMain">
        ...
        <div class="store_box" v-show="tabIndex === 2">
          ...
          <div class="detail-box" v-if="tabName == '店铺详情'">
            ...
            <div class="detail-item" v-if="get_recommend_goods && get_recommend_goods.length > 0">
              ...
              <div class="goods-box">
                <div class="good-item" v-for="(good, i) in get_recommend_goods" :key="i" @click.stop="toGood(good.goods_id)">
                  ...
                  <div class="goods_content_show" style="display: flex;flex-wrap: wrap;margin: 5px 0;" v-if="good.goods_content_show">
                    <!-- 商品内容显示 #81889-->
          ...
          <div class="community-box" v-if="tabName == '门店微贴'">
            ...
            <!-- <c-flow :showLoading="cisLoadMore" @loadMore="loadMore" :list="menuList[this.tabIndex2].list"></c-flow> -->
          </div>
          <div class="live-box" v-if="tabName == '门店直播'">
            <c-live :recordsList="menuList[this.tabIndex2].list" :showtitle="false"></c-live>
          </div>
          <div class="member-box" v-if="tabName == '门店员工'">
            <div class="member-item" v-for="(member, index) in menuList[this.tabIndex2].list" :key="index">
          ...
          <div class="group-box" v-if="tabName == '门店拼团'">
            <c-grouplist :list="menuList[this.tabIndex2].list" :store_id="$route.params.store_id"></c-grouplist>
          </div>
          <div class="group-box" v-if="tabName == '定金阶梯团'">
            <deposit-ladder-cell
              v-for="(item, index) in menuList[this.tabIndex2].list"
