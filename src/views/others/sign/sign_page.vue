  ...
  <div id="contract">
    ...
    <div v-if="showPage">
      ...
      <div style="transform: translate(0) !important;">
        ...
        <signButton v-if="signSuccess || signWait" style="margin-top: 30px; transform: translateX(23%) !important;"></signButton>
      </div>
    ...
    <van-popup v-model="showContent" round position="bottom" :style="{ height: '50%' }">
      ...
      <div class="Identify" v-if="auth_status == 1">
        <div v-if="company_seals.length>0" style="margin-bottom: 0.5rem;">
          ...
          <div class="seal-box">
            <div @click.stop="signPic" class="seal-item" v-for="seal in company_seals" :key="seal.id" :id="seal.id"
