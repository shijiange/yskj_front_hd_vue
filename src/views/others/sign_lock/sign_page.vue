  ...
  <div id="contract">
    ...
    <div v-if="showPage">
      ...
      <div style="transform: translate(0) !important;">
        ...
        <signButton v-if="signSuccess || signWait" style="margin-top: 30px; transform: translateX(23%) !important;" :signIndex="'signContractLock'"></signButton>
      </div>
      ...
      <div class="btn" :class="[fun.getPhoneEnv() == 3 ? 'pcStyle' : '']"
        ...
        <!--<div style="flex: 1; text-align: left; display: flex; align-items: center;" >-->
          <!--@click="toShowContent"<i class="iconfont icon-yq_gaizhang"></i><span style="color: #ff2c29; width: 8rem;">点这里盖章</span>-->
        <!--</div>-->
    ...
    <van-popup v-model="showContent" round position="bottom" :style="{ height: '50%' }">
      <div class="noIdentify" v-if="is_person_auth != 1 || is_company_auth != 1">
        <p class="title">请先完成实名认证</p>
